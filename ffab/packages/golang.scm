...
(define-public go-github-com-lucasb-eyer-go-colorful
  (package
    ...
    (synopsis "Golang colour manipulation library")
    (description
...
@item Linear RGB: See gamma correct rendering.

@item CIE-XYZ: CIE's standard color space, almost in [0..1].
