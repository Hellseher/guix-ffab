    ...
    astronomy.org          SunPy                   [0/3][0%]    :author:p2:
    ...
    python.org             Py3AMF                  [8/12][66%]  :author:
    ...
    golang.org             github.com/gin-gonic    [/][%]       :author:
    ...
    version-control.org    lazygit                 [0/4][0%]    :p1:
    python.org             opencv-python           [0/4][0%]    :p1:
    lisp.org               feedback                [/][%]       :p1:
    ...
    lisp.org               repo                    [0/4][0%]    
    lisp.org               qt-libs                 [/][%]       
    lisp.org               net.mfiano.lisp.shadow  [/][%]       
    ...
    astronomy.org          specutils               [0/0][100%]  
    ...
    golang.org             valyala/fasthttp          [3/4][75%]   
    ...
    lisp.org               cl-mathstats              [4/4][100%]  :p4:
    lisp.org               metacopy                  [4/4][100%]  :p4:
