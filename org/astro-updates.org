...
- [ ] complex [0/7]
  - [ ] python-czml3 :: would be upgraded from 1.0.2 to 2.0.1, more packages required
  ...
  - [ ] gnuastro :: would be upgraded from 0.22 to 0.23, test fails
    - python-asdf :: 3.3.0->4.0.0
    - new nump is required
...
- [ ] issues [0/6][0%]
  ...
  - [ ] [PATCH 0/4] Astro update 2024-12 - Rust packages. <https://issues.guix.gnu.org/74729>.
  - [ ] warning: no tags were found for stuff
  - [ ] warning: no tags were found for python-asdf-compression
  - [ ] warning: no tags were found for sunclock
  - [ ] warning: no tags were found for unsio
** TODO updates-2025-01 [0/3][0%] :p1:
- date-time ::
- commit ::
- issues ::
- [ ] quick [0/0][0%]
