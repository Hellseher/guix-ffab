...
#+modified: <2024-02-14 Wed 14:37:55 GMT>
...
- [X] :inputs [5/5][100%]
  ...
  - [X] python-setuptools-scm
  - [X] python-scipy
*** TODO python-dust-attenuation [2/4][50%] :p1:
...
- [X] :inputs [3/3][100%]
  ...
  + [X] python-numpy
  + [X] python-pytest
*** TODO python-extinction [3/4][75%] :p2:
...
- [X] :inputs [5/5][100%]
  ...
  - [X] python-matplotlib
  - [X] python-numpy
*** TODO python-ewah-bool-utils [2/4][50%] :p1:
...
*** TODO python-nose-exclude [2/4][50%] :p1:
- [X] :packed <2024-02-02 Fri>
- [ ] :patch-sent
- [ ] :paptch-applied-upstream
- [X] :inputs [1/1][100%]
...
*** TODO python-radiospectra [3/4][75%] :p2:
...
*** TODO python-sunpy-soar [3/4][75%] :p2:
...
- [ ] complex [0/3][0%]
  ...
  - [ ] python-hvpy :: would be upgraded from 1.0.1 to 1.1.0. Tests require
    https://github.com/pydantic/pydantic-settings and the fresh version of pydantic. Big efforts.
** TODO updates-2024-02 [1/3][33%] :p1:
    ...
    (arguments
     (list
      ...
      #~(list "-n" (number->string (parallel-job-count)))))
           ...
           python-pytest-xdist
#+begin_example
gnu/packages/astronomy.scm (python-asdf-3.0): Enable parallel
