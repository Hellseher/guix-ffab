...
#+modified: <2025-06-20 Fri 22:01:43 BST>
...
- [X] :inputs [10/10][100%]
  ...
  - [X] python-setuptools-scm
  - [X] python-wheel
*** TODO python-astrowidgets [0/5][0%] :p5:
...
*** TODO java-jsofa [0/4][0%] :p1:
- https://github.com/Javastro/jsofa
- synopsis :: Java translation of IAU SOFA library
- [ ] :packed @20210512_JSOFA_Release
- [ ] :patch-sent
- [ ] :paptch-applied-upstream <2025-04-30 Wed>
- [ ] :inputs [0/0][0%]
...
** TODO LibreSpaceFoundation [/][%] :author:
...
- [X] :inputs [9/9][100%]
  ...
  - [X] python-scipy
  - [X] python-tables
** TODO rlancasteAstro [/][%] :author:
- https://github.com/rlancaste
*** TODO stellarsolver [/][%] :p5:
...
** TODO SpaceTelescopeScienceInstitue [28/39][71%] :author:
- https://www.stsci.edu/
...
*** WAIT python-costools [3/4][75%] :p3:
...
*** WAIT python-drizzlepac [3/4][75%] :p3:
...
*** TODO python-stpreview [1/5][20%] :p1:
