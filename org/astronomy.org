...
#+modified: <2023-01-17 Tue 20:45:04 GMT>
...
** DONE GreatAttractor [2/2][100%] :author:p5:
...
** TODO JuliaAstro [0/36][0%] :author:p1:
...
- [ ] :inputs [0/1][0%]
  - [ ] astropy
** TODO spacetelescope [2/20][10%] :author:
- https://www.stsci.edu/
...
- [X] :inputs [6/6][100%]
  ...
  - [X] python-semantic-version
  - [X] python-setuptools-scm
*** TODO python-spherical-geometry [2/4][50%]
...
- [ ] :paptch-applied-upstream
- [ ] :inputs [0/0][0%]
*** TODO python-stdatamodels [2/4][50%]
