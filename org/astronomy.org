...
#+modified: <2023-10-10 Tue 00:37:29 BST>
...
*** TODO python-pyregion [2/4][50%] :p1:
- https://github.com/astropy/pyregion
- [-] :packed <2023-10-05 Thu>
- [-] :patch-sent
- [X] :paptch-applied-upstream
- [X] :inputs [3/3][100%]
  - [X] python-pyparsing
...
*** TODO python-spectral-cube [1/4][25%] :p1:
...
*** TODO python-radio-beam [2/4][50%] :p1:
...
- [-] :inputs [11/13][84%]
  ...
  - [ ] plplot
    - [ ] :packed
** TODO spacetelescope [19/22][86%] :author:
- https://www.stsci.edu/
...
- complex [0/4][0%]
  - [ ] cfitsio :: would be upgraded from 4.2.0 to 3100: Require rebuild-the-world.
