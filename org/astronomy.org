...
#+modified: <2023-12-22 Fri 03:27:53 GMT>
...
*** TODO VisiOmatic [0/4][0%] :p5:
  ...
  - [ ] :paptch-applied-upstream
  - [ ] :inputs [0/0]
** TODO asdf-format [1/1][100%] :author:
- https://github.com/asdf-format
...
*** TODO python-specutils [1/4][25%] :p1:
...
** TODO karllark [0/2][0%] :author:
*** TODO python-dust-extinction [0/4][0%] :p4:
- https://github.com/karllark/dust_extinctionhttps://github.com/karllark/dust_extinction
...
- [-] :inputs [4/5][80%]
  ...
  - [X] python-scipy
*** TODO python-dust-attenuation [1/4][25%] :p4:
...
*** TODO python-radiospectra [0/4][0%] :p1:
...
*** TODO python-sunpy-soar [1/4][25%] :p1:
...
- [ ] pending [0/2][0%]
  ...
  - [ ] python-synphot :: Pack optional packages
...
- [ ] complex [0/6][0%]
  ...
  - [ ] python-astropy :: would be upgraded from 5.3.4 to 6.0.0. Margor update, require more work
...
* Coverage
| project                            |            guix | debian-astro | kernel | stsci-astroconda |
|------------------------------------+-----------------+--------------+--------+------------------|
| 21cmfast                           |                 |              | X      |                  |
| alfa                               |             2.2 |          2.2 |        |                  |
