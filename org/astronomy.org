...
#+modified: <2022-11-22 Tue 21:39:48 GMT>
...
** TODO SunPy [0/3][0%] :author:p1:
- https://sunpy.org/
- https://github.com/sunpy
*** TODO sunpy [1/4][25%] :p1:
...
- [-] :inputs [32/34][94%]
  ...
  - [X] python-glymur [1/1][100%]
    - [X] :packed <2022-07-02 Sat>
  - [X] python-h5netcdf [1/1][100%]
    - [X] :packed <2022-07-02 Sat>
  - [X] python-h5py
  - [X] python-hypothesis
  - [X] python-jplephem
