...
#+modified: <2023-11-14 Tue 01:21:48 GMT>
...
- issues ::
- quick [0/24][0%]
  - [ ] celestia :: would be upgraded from 1.6.3 to 1.6.4
  - [ ] gpredict :: would be upgraded from 2.2.1 to 2.3
  - [ ] libpasastro :: would be upgraded from 1.4.0-1.e3c218d to 1.4.1
  - [ ] python-asdf :: would be upgraded from 3.0.0 to 3.0.1
  - [ ] python-astroalign :: would be upgraded from 2.5.0 to 2.5.1
  - [ ] python-casa-formats-io :: would be upgraded from 0.2.1 to 0.2.2
  - [ ] python-crds :: would be upgraded from 11.17.7 to 11.17.9
  - [ ] python-fitsio :: would be upgraded from 1.2.0 to 1.2.1
  - [ ] python-hvpy :: would be upgraded from 1.0.1 to 1.1.0
  - [ ] python-hvpy :: would be upgraded from 1.0.1 to 1.1.0
  - [ ] python-jplephem :: would be upgraded from 2.19 to 2.20
  - [ ] python-jplephem :: would be upgraded from 2.19 to 2.20
  - [ ] python-pynbody :: would be upgraded from 1.4.1 to 1.4.2
  - [ ] python-rad :: would be upgraded from 0.17.1 to 0.18.0
  - [ ] python-roman-datamodels :: would be upgraded from 0.17.1 to 0.18.0
  - [ ] python-sgp4 :: would be upgraded from 2.22 to 2.23
  - [ ] python-spherical-geometry :: would be upgraded from 1.2.22 to 1.3.1
  - [ ] python-wiimatch :: would be upgraded from 0.3.1 to 0.3.2
  - [ ] splash :: would be upgraded from 3.8.4 to 3.9.0
- complex [0/0][0%]
  - [ ] aoflagger :: would be upgraded from 3.2.0 to 3.4.0
  - [ ] cfitsio :: would be upgraded from 4.2.0 to 4.3.0: Require rebuild-the-world.
  - [ ] casacore :: would be upgraded from 3.4.0 to 3.5.0
...
gnu/packages/astronomy.scm warning: no tags were found for aocommon
gnu/packages/astronomy.scm warning: no tags were found for skymaker
gnu/packages/astronomy.scm warning: no tags were found for stuff
gnu/packages/astronomy.scm warning: no tags were found for unsio
