...
#+modified: <2023-02-23 Thu 23:03:02 GMT>
...
- [ ] :paptch-applied-upstream
- [X] :inputs [0/0][0%]
** TODO poliastro [0/1][0%] :author:
- https://github.com/poliastro
- https://www.poliastro.space/
*** TODO python-poliastro [/][%] :p1:
...
** TODO JuliaAstro [4/35][11%] :author:p1:
...
*** TODO julia-astrobase [1/4][25%] :p1:
...
*** TODO julia-astrotime [2/4][50%] :p1:
...
*** TODO julia-earthorientation [2/4][50%] :p1:
...
- [X] :inputs [6/6][100%]
  ...
  - [X] python-semantic-version
  - [X] python-setuptools-scm
*** TODO python-spherical-geometry [2/4][50%] :p1:
