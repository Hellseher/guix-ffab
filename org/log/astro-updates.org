...
** TODO updates-2025-09 [0/2][0%]
- date-time ::
- commit ::
- pull-request ::
- [-] quick [2/22][9%]
  - [ ] indi :: would be upgraded from 2.1.5 to 2.1.5.1
  - [ ] python-asdf-standard :: would be upgraded from 1.3.0 to 1.4.0
  - [ ] python-asdf :: would be upgraded from 4.4.0 to 4.5.0
  - [ ] python-astroml :: would be upgraded from 1.0.2.post1 to 1.0a1
  - [X] python-astropy-iers-data :: would be upgraded from 0.2025.8.18.0.40.14 to 0.2025.9.8.0.36.17
  - [ ] python-astroquery :: would be upgraded from 0.4.10 to 0.4.dev5750
  - [ ] python-camb :: would be upgraded from 1.6.2 to 1.6.4
  - [ ] python-cesium :: would be upgraded from 0.12.1 to 0.12.4
  - [ ] python-crds :: would be upgraded from 12.1.11 to 13.0.3
  - [ ] python-drizzlepac :: would be upgraded from 3.7.1 to 3.10.0
  - [ ] python-healpy :: would be upgraded from 1.18.1 to github-devel
  - [ ] python-irispy-lmsal :: would be upgraded from 0.3.1 to 0.4.0
  - [ ] python-jplephem :: would be upgraded from 2.22 to 2.23
  - [ ] python-linetools :: would be upgraded from 0.3.2 to 0.3.dev2231
  - [ ] python-naima :: would be upgraded from 0.10.0 to 0.10.3
  - [ ] python-pixell :: would be upgraded from 0.29.0 to 0.30.0
  - [ ] python-pynbody :: would be upgraded from 1.6.0.post0 to 2.3.0
  - [ ] python-reproject :: would be upgraded from 0.14.1 to 0.15.0
  - [ ] python-space-dolphin :: would be upgraded from 1.1.3 to 1.2.0
  - [ ] python-stwcs :: would be upgraded from 1.7.3 to 1.7.5
  - [ ] python-sunraster :: would be upgraded from 0.6.1 to 0.6.2
  - [X] splash :: would be upgraded from 3.11.4 to 3.11.5
- [ ] issues [0/0][0%]
  - Remove celestia-gtk https://codeberg.org/guix/guix/issues/2338
