...
#+modified: <2024-11-30 Sat 15:25:58 GMT>
...
** TODO dfm [1/1][100%] :author:
*** DONE python-george [4/4][100%]
...
** TODO lzkelley [1/2][50%] :author:
*** DONE python-kalepy [4/4][100%]
CLOSED: [2024-11-30 Sat 15:25]
...
- [ ] :paptch-applied-upstream
- [ ] :inputs [0/0][0%]
** TODO cdgriffith [1/1][100%] :author:
- https://github.com/cdgriffith
- https://codecalamity.com/
*** DONE python-puremagic [4/4][100%]
