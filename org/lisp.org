...
#+modified: <2023-03-15 Wed 21:32:09 GMT>
...
** TODO Shinmera/Shirakumo [13/26][50%] :author:
...
*** TODO cl-3d-quaternions [3/4][75%] :p3:
...
*** TODO cl-3d-transforms [3/4][75%] :p3:
...
- [X] :inputs [5/5][100%]
  - [X] sbcl-3d-matrices-ffab
  - [X] sbcl-3d-quaternions
  - [X] sbcl-3d-vectors-ffab
...
- [X] :inputs [8/8][100%]
  ...
  - [X] sbcl-trivial-extensible-sequences
...
- [-] :inputs-additions
  - notes :: Additional system which may need to be availalbe to make trial full fiture operational.
  - [X] alloy
    + [X] :packed <2021-11-07 Sun>
  - [-] backends [2/4]
